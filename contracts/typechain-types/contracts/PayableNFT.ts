...
export interface PayableNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "authorAddress"
  ...
  encodeFunctionData(
    functionFragment: "authorAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface PayableNFT extends BaseContract {
  connect(runner?: ContractRunner | null): PayableNFT;
  waitForDeployment(): Promise<this>;

  interface: PayableNFTInterface;
  ...
  authorAddress: TypedContractMethod<[], [string], "view">;
  ...
  ): TypedContractMethod<[_newMintPrice: BigNumberish], [void], "nonpayable">;
  getFunction(
